...
function clean_journal_layouts() {
	$layout_options = array(
		'left-sidebar' 	=> esc_html__( 'Dark', 'clean-journal' ),
...
function clean_journal_featured_content_types() {
	$featured_content_types = array(
		'demo-featured-content' => esc_html__( 'Demo Featured Content', 'clean-journal' ),
		'featured-page-content' => esc_html__( 'Featured Page Content', 'clean-journal' ),
	);
...
function clean_journal_featured_slider_types() {
	$featured_slider_types = array(
		'demo-featured-slider' => esc_html__( 'Demo Featured Slider', 'clean-journal' ),
		'featured-page-slider' => esc_html__( 'Featured Page Slider', 'clean-journal' ),
	);
...
function clean_journal_featured_slide_transition_effects() {
	$featured_slide_transition_effects = array(
		...
		'shuffle'	=> esc_html__( 'Shuffle', 'clean-journal' ),
	);
...
function clean_journal_get_content() {
	...
	$clean_journal_content['left'] 	= sprintf( _x( 'Copyright &copy; %1$s %2$s. All Rights Reserved.', '1: Year, 2: Site Title with home URL', 'clean-journal' ), esc_attr( date_i18n( __( 'Y', 'clean-journal' ) ) ), '<a href="'. esc_url( home_url( '/' ) ) .'">'. esc_attr( get_bloginfo( 'name', 'display' ) ) . '</a>' );
