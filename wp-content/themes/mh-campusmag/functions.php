...
if (!function_exists('mh_magazine_lite_loop_layout')) {
	function mh_magazine_lite_loop_layout() {
		...
		while (have_posts()) : the_post();
			...
			if ($counter >= 1) {
				echo '<div class="mh-col-1-2 mh-posts-grid-col clearfix">' . "\n";
